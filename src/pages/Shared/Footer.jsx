...
const Footer = () => {
  return (
    <div>
      ...
      <div className="bg-gradient-to-b from-yellow-300 to-orange-400 px-16 lg:px-32 pt-40 pb-10 ">
        <div className="grid lg:grid-cols-7 justify-between space-y-10 lg:space-y-0">
        ...
        <p className="text-xs text-gray-800 pt-16 text-center">
